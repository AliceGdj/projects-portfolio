    ...
    <Layout home>
      ...
      <section className={utilStyles.headingMd}>
        ...
        <div className={utilStyles.cta}>
          <a href="https://github.com/AliceGdj/resume/raw/main/Resume_Alice_Grandjean.pdf" target="_blank" rel="noopener noreferrer" className={styles.download_resume}>&gt;&gt; Download my Resume &lt;&lt;</a>
        </div>
      </section>
    </Layout>
  );
